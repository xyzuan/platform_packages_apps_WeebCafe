...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String WEEBSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, WEEBSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, WEEBSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(WEEBSETTINGSNS, "interval");
            if(newInterval != null)
